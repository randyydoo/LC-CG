...
|[Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)| [Python](./easy/RemoveDuplicatesFromSortedArray.py) | Easy | Recursion or 2 pointer |
