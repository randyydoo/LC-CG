...
|20|[Valid Parenthesses](https://leetcode.com/problems/valid-parentheses/)| [Python](./easy/ValidParentheses.py) | Easy | Check prev and pop 2x | 
...
|11|[Container with Most Water](https://leetcode.com/problems/container-with-most-water/)| [Python](./easy/ContainerMostWater.py) | Medium | Two pointer  |
|54|[Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | [Python](./easy/SpiralMatrix.py) | Medium | Keep track of L,R,T,B | 
|150|[Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation/) | [Python](./easy/EvaluateReversePolishNotation.py) | Medium | Pop 2x and append | 
|155|[Min Stack](https://leetcode.com/problems/min-stack/) | [Python](./easy/MinStack.py) | Medium | Blank |
|167|[Two Sum II - Input Array is Sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/) | [Python](./easy/TwoSum2.py) | Medium | Two Pointer | 
