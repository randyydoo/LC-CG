...
|49|[Group Anagams](https://leetcode.com/problems/group-anagrams/) | [Python](./medium/GroupAnagrams.py) [C++](./medium/ValidAnagrams.cpp) | Medium | Use sorted and hash with list|
